...
const { createBloc_etablissement,deleteBloc_etablissement,getBloc_etablissement,getBloc_etablissements,updateBloc_etablissement,createFilterObj,getBloc_etablissementByEtab } = require('../services/blocEtablissementService');
...
router.route('/byetab/:id').get(getBloc_etablissementByEtab)
