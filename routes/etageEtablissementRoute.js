...
const { createEtage_etablissement,deleteEtage_etablissement,getEtage_etablissement,getEtage_etablissements,updateEtage_etablissement, getEtage_etablissementsByBloc } = require('../services/etageEtablissementService');
...
router.route('/bybloc/:id').get(getEtage_etablissementsByBloc)
